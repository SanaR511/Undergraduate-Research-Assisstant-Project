                ...
                for (int j = 0; j < matrix[i].length; j++) {
                    ...
                    if (map.containsKey(i)) {
                      sufferageList[i] = Integer.MIN_VALUE;
                        ...
                        } else if (min1 != Integer.MIN_VALUE && matrix[i][j] != min1 && matrix[i][j] < min2) {
                            min2 = matrix[i][j];
                        }

                        if (min2 != Integer.MIN_VALUE) sufferage = min1 - min2;
                        if (sufferageList[i] != Integer.MIN_VALUE && min2 != Integer.MIN_VALUE)
